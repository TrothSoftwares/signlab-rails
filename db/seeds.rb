...
Agent1 = Agent.create(name: 'Agent one Name', contactname: 'Agent one Contact Name ' , contactno: 'Agent one contactno' , othcontactno: 'Agent one Othcontactno' ,othrefdetails:'Agent one  oth ref details')
...
Customer1 = Customer.create(name: 'Customer One', contactname: 'Customer One contact name' , contactno: 'Customer One contactno' , othcontactno: 'Customer One othcontactno', othrefdetails:'Customer One oth ref details')
